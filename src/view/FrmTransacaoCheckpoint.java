 ...
 * @author Takeshi
 */
public class FrmTransacaoCheckpoint extends javax.swing.JFrame {

    /**
     * Creates new form FrmMovimentacao
     */
    public FrmTransacaoCheckpoint() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmTransacaoCheckpoint.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmTransacaoCheckpoint().setVisible(true);
            }
        });
    }
